...
# Taken from: https://raw.githubusercontent.com/Acciorocketships/generalised-aggregation/main/genagg/MLPAutoencoder.py
    ...
    def __init__(
        ...
        for i in range(len(self.layer_sizes) - 1):
            ...
            layers_reverse.append(
                nn.Linear(layer_sizes[len(self.layer_sizes) - 1 - i], layer_sizes[len(self.layer_sizes) - 2 - i]))
